...
public class WishListActivity extends AppCompatActivity  implements ItemsAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.wishlist_activity_rv);
        emptyMessage = findViewById(R.id.wishlist_empty_message);
    ...
    private void setUpRecyclerView() {
        ...
        itemsAdapter = new ItemsAdapter(WishListActivity.this, itemsList, this);
    ...
    @Override
    public String toString() { return "WishListActivity"; }
}